...
<div class="card mb-4">
	<div class="card-header">
		<h5 class="mb-0">
			<i class="fas fa-plus-circle"></i> 새 쿠폰 생성
		</h5>
	</div>
	<div class="card-body">
		<form action="<c:url value='/admin/coupon/create'/>" method="post">
			...
			<form action="<c:url value='/admin/coupon/create'/>" method="post">
				...
				<div class="row mb-3">
					<div class="col-md-6">
						<div class="mb-3">
							<label class="form-label">최소 구매 금액</label> <input type="number"
								class="form-control" name="minimum_purchase" required>
						</div>
					</div>
					<div class="col-md-6">
						<div class="mb-3">
				...
				<div class="row mb-3">
					<div class="col-md-6">
						<div class="mb-3">
							<label class="form-label">사장님 ID</label> <input type="text"
								class="form-control" name="owner_id" required>
						</div>
					</div>
					<div class="col-md-6">
						<div class="mb-3">
							<label class="form-label">가게 ID</label> <input type="text"
								class="form-control" name="store_id" required>
						</div>
					</div>
				</div>
				<div class="row mb-3">
				...
				<tbody>
					<c:forEach var="coupon" items="${couponList}">
						<tr>
							...
							<td><fmt:formatNumber value="${coupon.minimum_purchase}"
									type="currency" currencySymbol="₩" /></td>
